...
remove_tcmN_reads_subfive  <- c("JOFH01000019.1-2512/2", "gi|529222834|ref|NC_021985.1|-10672/2", "gi|529222834|ref|NC_021985.1|-88464/2", "AZXI01000002.1-11042/2", "JOFH01000019.1-21136/2")
remove_tcmN_reads_median  <- c("gi|529222834|ref|NC_021985.1|-10672/2", "gi|529222834|ref|NC_021985.1|-88464/2", "AZXI01000002.1-11042/2")
...
#TcmN_filtered_final_distinct <- TcmN_filtered_final_updated %>% arrange(desc(HMMScore)) %>% group_by(readID, Sample) %>% top_n(1) %>% filter(row_number()==1) %>% ungroup() 
