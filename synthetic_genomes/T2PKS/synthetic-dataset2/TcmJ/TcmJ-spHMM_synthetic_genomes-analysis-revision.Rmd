...
knitr::opts_knit$set(root.dir = '/Users/francinecamacho/Google Drive/T2PKS-paper/computational_analysis/synthetic_genomes/revision-synthetic-genomes/HMM-analysis/TcmJ')
```
...
pks_genomes_median_check <- c("AZXI01000002.1", "JOFH01000019.1", "AZXI01000013.1", "gi|928414697|gb|LGKI01000478.1|", "gi|928410510|gb,|LGKI01000811.1|", "LZZI01000061.1", "gi|754859657|ref|NZ_CP009285.1|", "LZZI01000035.1", "gi|529222834|ref|NC_021985.1|", "OBDZ01000007.1", 
                              "AZXI01000009.1", "JOFH01000003.1", "AZXI01000017.1", "LZZI01000045.1", 
                              "OBDZ01000030.1", "LZZI01000001.1")
...
pks_genomes_subfive_check <- c("JOFH01000006.1", "AZXI01000002.1", "JOFH01000019.1", "AZXI01000013.1", "gi|928414697|gb|LGKI01000478.1|", "LZZI01000099.1", "gi|529222834|ref|NC_021985.1|", "AZXI01000006.1", 
                               "LZZI01000042.1", "gi|640930117|gb|JJOH01000105.1|", "gi|928410510|gb|LGKI01000811.1|", "LZZI01000061.1", "gi|754859657|ref|NZ_CP009285.1|", "LZZI01000035.1",
                               "OBDZ01000007.1", "AZXI01000009.1", "JOFH01000003.1", "LZZI01000045.1", 
                               "AZXI01000017.1", "gi|1098133681|emb|FOXX01000032.1|", "gi|1081599064|emb|FMWJ01000030.1|", "JOFH01000047.1", "gi|1098135105|emb|FOXX01000010.1|", "OBDZ01000030.1",
                               "gi|1098133853|emb|FOXX01000026.1|", "LZZI01000001.1", "OBDZ01000041.1", "gi|1081602630|emb|FMWJ01000001.1|", "JOFH01000001.1", "gi|928417113|gb|LGKI01000312.1|", "OBDZ01000003.1", 
                               "AZXI01000003.1", "LZZI01000100.1")
...
pks_genomes_plusfive_check <- c("JOFH01000019.1", "JOFH01000003.1")
...
#parseReads(remaining_hmm_tcmj_pos_median_check, "cyclaseTcmJ", "/Users/francinecamacho/Google Drive/T2PKS-paper/computational_analysis/synthetic_genomes/revision-synthetic-genomes/HMM-analysis/TcmJ/hmm-unique-analysis/median_score/")
#parseReads(remaining_hmm_tcmj_pos_subfive_check, "cyclaseTcmJ", "/Users/francinecamacho/Google Drive/T2PKS-paper/computational_analysis/synthetic_genomes/revision-synthetic-genomes/HMM-analysis/TcmJ/hmm-unique-analysis/minus_five_score/")

#parseReads(remaining_hmm_tcmj_pos_plusfive_check, "cyclaseTcmJ", "/Users/francinecamacho/Google Drive/T2PKS-paper/computational_analysis/synthetic_genomes/revision-synthetic-genomes/HMM-analysis/TcmJ/hmm-unique-analysis/plus_five_score/")
...
remove_tcmJ_reads_subfive  <- data.frame(
   readID =   c("NZ_JOFH01000019__S.olivaceus__IG94_RS0121830", "gi|529222834|ref|NC_021985.1|-6045910/2", "gi|529222834|ref|NC_021985.1|-556412/2", "AZXI01000002.1-11106/2"), 
   Sample = c("synthetic_stool_low_S2", "synthetic_stool_low_S32", "synthetic_stool_low_S32", "synthetic_stool_low_S52"))

subfive_false_postives <- subfive_remaining_hmm_tcmj %>% anti_join(.,remove_tcmJ_reads_subfive)

remove_tcmJ_reads_median <- data.frame(
  readID = c("gi|529222834|ref|NC_021985.1|-6045910/2", "AZXI01000002.1-11106/2"), 
  Sample = c("synthetic_stool_low_S32", "synthetic_stool_low_S52")) 

median_false_postives <- median_remaining_hmm_tcmj %>% anti_join(.,remove_tcmJ_reads_median)


tcmj_f1_cutoff_median<- calculate_F1(TcmJ_filtered_median, median_false_postives, tcmJ_blast_intervals, unique(cyclaseTcmJ_recoded$interval))
...
parseReads(TcmJ_filtered_final, "cyclaseTcmJ", "/Users/francinecamacho/Google Drive/T2PKS-paper/computational_analysis/synthetic_genomes/revision-synthetic-genomes/read-quantification/TcmJ/sample-readIDs-files")
...
final_ggplot_tcmj_full<- tcmj_f1_df %>% group_by(interval) %>% top_n(1, F1) %>% ungroup() %>% ggplot(., mapping = aes(x = interval, y = F1, group= 1 )) + geom_point()+ ylim(0,1)+
    geom_line() +  geom_hline(yintercept=.50, linetype="dashed", 
                color = "red", size=1) + geom_hline(yintercept=0.1396942, linetype="dashed", 
