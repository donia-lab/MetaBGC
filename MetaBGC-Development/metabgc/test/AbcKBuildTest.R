InputFiles.HMMRun <- "OxyN/data/CombinedHmmSearch.txt"
InputFiles.BLAST_TP_NoCov <- "OxyN/data/CombinedBLASTSearch.txt"
InputFiles.GeneIntervalPos <- "OxyN/output/build/Gene_Interval_Pos.txt"
InputParam.HMM_Model_Name = 'OxyN'
InputParam.F1_Threshold = 0.50
OutputFiles.HMMOutDir <- "OxyN/output/build/spHMMs"
OutputFiles.HMMHighPerfOutDir <- "OxyN/output/build/HiPerf"
library(tidyverse)
library(ggsci)
library(ggpubr)
library(dplyr)
