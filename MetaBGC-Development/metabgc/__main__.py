...
@click.option('--prot_seq_directory',required=True,
              type=click.Path(exists=True,dir_okay=True,readable=True),
              help= "Input directory with the protein family positive amino acid fasta files used for simulation.")
@click.option('--nucl_seq_directory',required=True,
              type=click.Path(exists=True,dir_okay=True,readable=True),
              help= "Input directory with the protein family positive nucleotide fasta files used for simulation.")
@click.option('--output_directory', '-o',required=True,
              type=click.Path(exists=True,dir_okay=True,writable=True),
              help= "Directory to save results.")
