...
#parseReads(remaining_hmm_tcmi_pos_median_check, "cyclaseTcmI", "/Users/francinecamacho/Google Drive/T2PKS-paper/computational_analysis/synthetic_genomes/revision-synthetic-genomes/HMM-analysis/TcmI/hmm-unique-analysis/median_score/")

#parseReads(remaining_hmm_tcmi_pos_subfive_check, "cyclaseTcmI", "/Users/francinecamacho/Google Drive/T2PKS-paper/computational_analysis/synthetic_genomes/revision-synthetic-genomes/HMM-analysis/TcmI/hmm-unique-analysis/minus_five_score/")

#parseReads(remaining_hmm_tcmi_pos_plusfive_check, "cyclaseTcmI", "/Users/francinecamacho/Google Drive/T2PKS-paper/computational_analysis/synthetic_genomes/revision-synthetic-genomes/HMM-analysis/TcmI/hmm-unique-analysis/plus_five_score/")
...
final_ggplot_tcmi_full<- tcmi_f1_df %>% group_by(interval) %>% top_n(1, F1) %>% ungroup() %>% ggplot(., mapping = aes(x = interval, y = F1, group= 1 )) + geom_point()+ ylim(0,1)+
    geom_line() +  geom_hline(yintercept=.50, linetype="dashed", 
                color = "red", size=1) + geom_hline(yintercept=0.7419227, linetype="dashed", 
