...
#TcmN_f1_cutoff_plusfive <-calculate_F1(compareCyclaseReads(cyclaseTcmN_recoded %>% filter(HMMScore >=30),t2pksBlastDF)) #0.08862335 (534 common, 10983, blast unique, 0 hmmunique)
