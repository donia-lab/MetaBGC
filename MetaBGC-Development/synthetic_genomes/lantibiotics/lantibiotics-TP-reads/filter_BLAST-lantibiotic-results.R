...
###################################################
t2pksBlastfiles<- list.files(path= "/tigress/DONIA/fcamacho/TypeII-PKS-Manuscript/synthetic-genomes/other-BGCs-poc/lantibiotics/lantibiotics-TP-reads",
...
write_delim(t2pksBlastDF_filter, "lantibioticBlastDF_filter-results.txt", col_names=T, delim = "\t")
